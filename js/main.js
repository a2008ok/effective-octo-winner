$(function () {
  ...
  // -------------------------------------------------------------------------
    ...
    (function () {
        ...
        $("#generate").on("click", function() {
            if (!$(this).hasClass("disabled")) {
                ...
                var s = document.getElementById("avatarPreview");
                u.drawImage(g, -n * o, -i * o, d * o, c * o);
                u.drawImage(s, 0, 0, e, e);
    ...
    $("#pic1").on("click", function() {
        $("#avatarPreview").attr('src' , './picture/pic1.png');
    });

    $("#pic2").on("click", function() {
        $("#avatarPreview").attr('src' , './picture/pic2.png');
    });

    $("#pic3").on("click", function() {
        $("#avatarPreview").attr('src' , './picture/pic3.png');
    });

    $("#pic4").on("click", function() {
        $("#avatarPreview").attr('src' , './picture/pic4.png');
    });
